...
public class SetActivity extends AppCompatActivity {
    ...
    private void drawUi() {
        ...
        activitySetBinding.setOther.addView(ViewTools.createTextCard(this, getString(R.string.log_title), () -> startActivity(new Intent(this, LogActivity.class))).getRoot());
